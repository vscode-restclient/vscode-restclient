...
export const SecretDescription = "Reads a secret stored in the editor's secret storage (HttpKeeper: Set secret). Never written to the file";
export const UuidVariableName = "$uuid";
export const UuidDescription = "Add a RFC 4122 v4 UUID (JetBrains alias of $guid)";
export const IsoTimestampVariableName = "$isoTimestamp";
export const IsoTimestampDescription = "Add the current UTC datetime in ISO 8601 (JetBrains alias of $datetime iso8601)";
export const RandomIntegerJetBrainsVariableName = "$random.integer";
export const RandomIntegerJetBrainsDescription = "Random integer between min (included) and max (excluded): {{$random.integer(min,max)}} (JetBrains alias of $randomInt)";
